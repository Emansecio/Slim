...
use slim_core::session::{branch, recover, SessionIndex, SessionSnapshot, SessionWriter};
...
#[test]
fn branch_keeps_parent_identity_and_rebuildable_caches() {
    ...
    let snapshot = SessionSnapshot::rebuild(&child.events);
